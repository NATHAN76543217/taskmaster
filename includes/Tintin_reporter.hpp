...
# define LOG_LEVEL_WARNING_MSG_COLOR  "\033[38;2;250;230;40m"
...
# define LOG_LEVEL_CRITICAL_MSG		"[" LOG_LEVEL_CRITICAL_COLOR "CRITICAL" RESET_ANSI "] " LOG_LEVEL_CRITICAL_MSG_COLOR
...
# define LOG_CATEGORY_NAME_MAXSIZE	8
# define LOG_CATEGORY_NAME_MAXSIZE	8
...
class Tintin_reporter
{
	...
	public:
		...
		std::string		timeToString( const struct timeval & time );
